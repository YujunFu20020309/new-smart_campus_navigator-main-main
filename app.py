...
def get_campus_route(
    ...
    *,
    ...
    try:
        matched_rule = match_forced_route_rule(
            start_id,
            end_id,
    ...
    if matched_rule is not None:
        ...
        try:
            ...
            return route_failure("hybrid_forced_route", CAMPUS_MODE_ID, str(exc))
        forced_route = route_with_forced_rule(
            start_place,
            end_place,
            matched_rule,
            places_df=places_df,
    ...
    if edges_df is None:
        ...
        try:
            ...
            local_route = compute_campus_route(graph, start_id, end_id, mode=CAMPUS_MODE_ID)
...
def calculate_route_for_mode(
    ...
    *,
    ...
    if mode_id == OSRM_MODE_ID:
        ...
        return get_osrm_route_for_places(
            places_df,
            start_id,
            end_id,
            allow_live_osrm=allow_live_osrm,
    ...
    if mode_id == COMPARE_MODE_ID:
        ...
        try:
            osrm_route = get_osrm_route_for_places(
                places_df,
                start_id,
                end_id,
                allow_live_osrm=allow_live_osrm,
...
def main() -> None:
    ...
    with map_col:
        st_folium(map_obj, width=900, height=560, returned_objects=[])
